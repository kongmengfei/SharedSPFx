...
export default class ItRequestsWebPart extends BaseClientSideWebPart<IItRequestsWebPartProps> {
  ...
  public render(): void {
    ...
    $('table', this.domElement).DataTable({
      'ajax': {
        'url': `${this.context.pageContext.web.serverRelativeUrl}/_api/web/lists/getbytitle('${escape(this.properties.listName)}')/items?$select=ID,BusinessUnit,Category,Status,DueDate,AssignedTo/Title&$expand=AssignedTo/Title`,
